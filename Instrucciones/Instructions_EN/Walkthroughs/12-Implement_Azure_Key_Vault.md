...
2. From the **All services** blade, search for and select **Key vaults**, then select **+ Add, + Create, or + New**.
...
4. Click **Review + create** and then after the validation click **Create**. 
